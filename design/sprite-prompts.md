...
Keep every line of prompt A except `Format`. Replace it with this, and attach
the approved key frame as a reference image.
...
scale, centred in its cell, walking toward the top of the image.
